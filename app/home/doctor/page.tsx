...
const DoctorDashboard = () => {
  ...
  if (isLoading || isAppointmentLoading || isRoomsLoading)
    return <p>Loading...</p>
  ...
  return (
    <div className="flex flex-col items-center min-h-screen bg-light-blue-50 p-6">
      <h1 className="text-2xl font-bold mb-6">
        {' '}
        👋 Hello, Dr. {Doctordata.users.first_name}!
      </h1>
      ...
      <div className="w-full max-h-10xl overflow-shown mb-35">
        <div className="grid grid-cols-12 gap-6">
          ...
          <div
            className="col-span-8 grid grid-cols-1 gap-6"
                ...
                <table className="w-full border-collapse border border-gray-300">
                  ...
                  <tbody>
                    {AppointmentData && AppointmentData.length > 0 ? (
                      AppointmentData.slice(0, visibleAppointments).map(
                        (patient: any) => (
                          <tr
                          ...
                          >
                            <td className="border border-gray-300 p-2">
                              {patient.patients.users.first_name}{' '}
                              {patient.patients.users.last_name}
                            </td>
                            <td className="border border-gray-300 p-2">
          ...
          <div className="col-span-4 grid grid-cols-1 gap-6">
            ...
            <div className="bg-white p-4 shadow rounded">
              ...
              <div className="text-black space-y-2">
                <div>
                  <p>
                    <strong>First Name:</strong> {Doctordata.users.first_name}
                  </p>
                  <p>
                    <strong>Last Name:</strong> {Doctordata.users.last_name}
                  </p>
                  <p>
                    <strong>Gender:</strong> {Doctordata.users.gender}
                  </p>
                  <p>
                    <strong>Date of Birth:</strong>{' '}
                    {Doctordata.users.date_of_birth}
                  </p>
                  <p>
                    <strong>National ID:</strong> {Doctordata.users.national_id}
                  </p>
                  <p>
                    <strong>Phone Number:</strong>{' '}
                    {Doctordata.users.phone_number}
                  </p>
                </div>
                <div className="pt-2 border-t border-gray-200 mt-2">
                  <p>
                    <strong>Staff ID:</strong> {Doctordata.staff_id}
                  </p>
                  <p>
                    <strong>License Number:</strong> {Doctordata.license_number}
                  </p>
                  <p>
                    <strong>Staff Type:</strong> {Doctordata.staff_type}
                  </p>
                  <p>
                    <strong>Employment Status:</strong>{' '}
                    {Doctordata.employment_status}
                  </p>
                  <p>
                    <strong>Date Hired:</strong> {Doctordata.date_hired}
                  </p>
                  <p>
                    <strong>Department:</strong> {Doctordata.departments.name}
                  </p>
                </div>
              </div>
            </div>
