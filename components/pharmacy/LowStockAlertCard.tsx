...
export default function LowStockAlertCard({ id, name, dosage, quantity, onRestock }: AlertProps) {
  ...
  return (
    <Card className={cn(
      ...
      isOutOfStock && "bg-red-50/50 border-red-300 dark:bg-red-900/10 dark:border-red-900/30",
      isVeryCritical && !isOutOfStock && "bg-orange-50/50 border-orange-200 dark:bg-orange-900/10 dark:border-orange-800/30",
      !isOutOfStock && !isVeryCritical && "border-yellow-300 dark:border-yellow-700/50"
    )}>
      <CardContent className="p-5 pb-3 flex flex-col gap-2">
        <div className="flex justify-between items-start">
          ...
          <Badge variant="outline" className={cn(
            "font-medium",
            isOutOfStock ? "bg-red-100 text-red-700 border-red-200 dark:bg-red-900/30 dark:text-red-400 dark:border-red-900/50" : 
            isVeryCritical ? "bg-orange-100 text-orange-700 border-orange-200 dark:bg-orange-900/30 dark:text-orange-400 dark:border-orange-900/50" :
        ...
        <div className="flex items-center gap-2 text-sm text-muted-foreground">
          <PillIcon className={cn(
            "h-3.5 w-3.5",
            isOutOfStock ? "text-red-500 dark:text-red-400" : 
            isVeryCritical ? "text-orange-600 dark:text-orange-400" : 
        ...
        <div className="h-1.5 w-full bg-muted rounded-full mt-1">
          <div 
            className={cn(
              "h-full rounded-full",
              isOutOfStock ? "bg-red-500 dark:bg-red-600" : 
              isVeryCritical ? "bg-orange-500 dark:bg-orange-600" : 
